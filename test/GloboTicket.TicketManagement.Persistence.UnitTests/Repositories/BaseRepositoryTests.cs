...
namespace GloboTicket.TicketManagement.Persistence.UnitTests.Repositories
{
    public class BaseRepositoryTests
    {
        ...
        public async Task AddAsyncTest()
        {
            ...
            var @event = await _mockDbContext.Object.Set<Event>().FindAsync(result.EventId);
            @event.ShouldNotBeNull();
            var eventsCount = await _mockDbContext.Object.Set<Event>().CountAsync();
            eventsCount.ShouldBe(7);
            result.ShouldNotBeNull();
            result.ShouldBeOfType<Event>();
        ...
        public async Task DeleteAsyncTest()
        {
            ...
            var @event = await _mockDbContext.Object.Set<Event>().FindAsync(oldEvent.EventId);
            @event.ShouldBeNull();
            var eventsCount = await _mockDbContext.Object.Set<Event>().CountAsync();
            eventsCount.ShouldBe(5);
        }
    }
}